...
- useRouteMatch does the same thing as Route. It tries matching the current URL.

2. How would you explain form validation to someone who has never programmed before?

- Form validation lets error messages be displayed if the user hasn't filled out the form with the necessary input.

3. In 1-2 sentences, define end to end testing.

- End to End testing is used to determine whether or not an application is doing what it's supposed to in any given situation, from start to finish.
